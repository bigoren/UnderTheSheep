...
class Song(Controller):
    ...
    song_list = ["lost.wav", "millenium.wav"] + (["silence.wav"] * 2) + ["outlier.wav", "essoteric.wav", "because.wav", "nocturne.wav"] + \
                 (["silence.wav"] * 2) + ["fever.wav", "alterego.wav", "useit.wav"] + (["background.wav"] * 6)
